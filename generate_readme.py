...
def get_provinces(base_path):
    provinces = [d for d in os.listdir(base_path) 
...
def get_dirs(path):
    return sorted([d for d in os.listdir(path) 
                   if os.path.isdir(os.path.join(path, d)) and d != ".git"])
